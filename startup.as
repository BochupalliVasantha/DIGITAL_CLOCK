	...
	; Compiler options:
	;
	; -I/opt/microchip/xc8/v1.36/include/ --ROM=0-3000 -Q --opt=all \
	; --asmlist --summary=psect,mem -Mpic18F4580.map -DCOMPILER= -intel \
	; i2c.p1 main_menu.p1 eeprom.p1 view_event.p1 rtc.p1 default_screen.p1 \
	; set_event.p1 set_date.p1 matrix_keypad.p1 set_time_date.p1 main.p1 \
	; clcd.p1 isr.p1 set_time.p1 set_view_events.p1 timer0.p1 \
	; -opic18F4580.hex
	;
